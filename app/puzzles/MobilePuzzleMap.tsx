...
const PUZZLE_PINS: PuzzlePin[] = [
  ...
  { id: 'turing-or-not',         title: 'Turing or Not Turing',            theme: 'AI',        desc: 'Read two conversation transcripts — determine which participant is an AI.',                                                                            lat: 47.0508, lng: 8.3102 },
